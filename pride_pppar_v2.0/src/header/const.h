...
integer*4,parameter :: maxsit=900,maxsat=190,maxepo=4320000
...
!
integer*4,parameter :: maxpar_sta=15,maxow_st=maxsat*10,maxpar=maxsit*(maxpar_sta+6)+maxsit*maxow_st
