type station
  character*4 name
  character*2 skd
  integer*4 iunit,lfnjmp,imet,ikin,iion,itrp,iptatx,ixyz
...
!! clock correction
  real*8 rclock,dclk0
  real*8 rclock_G,rclock_R,rclock_E,rclock_C,rclock_3,rclock_J
  real*8 dclk0_G,dclk0_R,dclk0_E,dclk0_C,dclk0_3,dclk0_J
!
!! observation info
