subroutine global_map(dmjd, dlat, dlon, dhgt, zd, gmfh, gmfw)
!
...
!
  ...
  REAL*8 dmjd, dlat, dlon, dhgt, zd, x, y, z
  REAL*8 gmfh, gmfw

  INTEGER*4 i, n, m, nmax, mmax
  REAL*8 doy, phh
  REAL*8 ah, bh, ch, aw, bw, cw
  REAL*8 ahm, aha, awm, awa
  REAL*8 c10h, c11h, c0h
  REAL*8 a_ht, b_ht, c_ht
  REAL*8 sine, cose, beta, gamma, topcon
  REAL*8 hs_km, ht_corr, ht_corr_coef

  REAL*8 V(10, 10), W(10, 10)
  REAL*8 ah_mean(55), bh_mean(55), ah_amp(55), bh_amp(55)
  REAL*8 aw_mean(55), bw_mean(55), aw_amp(55), bw_amp(55)
...
! hydrostatic
  ...
  ch = c0h + ((dcos(doy/365.25d0*2*PI + phh) + 1)*c11h/2 + c10h)*(1 - dcos(dlat))
  ...
  DO n = 0, nmax
    ...
    ENDDO
  ENDDO
  ah = (ahm + aha*dcos(doy/365.25d0*2.d0*PI))*1d-5
...
! wet
  ...
  DO n = 0, nmax
    ...
    ENDDO
  ENDDO
  aw = (awm + awa*dcos(doy/365.25d0*2*PI))*1d-5
