...
!! weight of observations
    ...
    OB%var(isat, 3) = (SITE%sigr/(vlight/FREQ1_J))**2
    OB%var(isat, 4) = (SITE%sigr/(vlight/FREQ1_J))**2
...
!! observation equation
    xrot = rot_f2j
    call partial_gnss_J(OB%npar, dloudx, drate, OB%pname, OB%ltog(1, isat), xrot, trpart, OB%amat(1, isat), &
                       LCF%prn(isat), jd, sod)
!
!! next satellite
  enddo
