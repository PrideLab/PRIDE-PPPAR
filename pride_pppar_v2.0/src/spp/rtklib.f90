...
!#ifndef NEXOBS
integer*4, parameter :: NEXOBS   = 0                   ! number of extended obs codes 
!#endif
...
real*8, parameter :: DTTOL = 0.025d0                   ! tolerance of time difference (s) 
...
integer*4, parameter :: MAXSOLNUM  = 86400*50          ! max number of solution in program
