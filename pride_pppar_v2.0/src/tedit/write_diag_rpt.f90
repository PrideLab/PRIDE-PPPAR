...
!
subroutine write_diag_rpt(flnrhd, nepo, nsat, jd0, ti, flagall, interval, sumepo, suitepo)
  implicit none
  include '../header/const.h'

  integer*4 nepo, sumepo, nsat, jd0, suitepo, flagall(suitepo, MAXSAT)
  real*8 ti(1:*), interval
  character*(*) flnrhd
!
!! local
  integer*4 i, j, ns, lfn, iepo, isat, ie, jd, iy, imon, id, ih, im
  integer*4 maxamb, totamb, remobs, avaobs, xamb(MAXEPO), flag(MAXSAT, suitepo)
  real*8 sec, sod
