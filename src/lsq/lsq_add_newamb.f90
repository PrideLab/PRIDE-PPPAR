...
!! add new ambiguity
      ...
      PM(NM%ipm + nbias)%iobs_G = 0
      PM(NM%ipm + nbias)%iobs_R = 0
      PM(NM%ipm + nbias)%iobs_E = 0
      PM(NM%ipm + nbias)%iobs_C = 0
      PM(NM%ipm + nbias)%iobs_3 = 0
      PM(NM%ipm + nbias)%iobs_J = 0
      PM(NM%ipm + nbias)%psat = isat
