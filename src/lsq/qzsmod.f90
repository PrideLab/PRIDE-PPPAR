...
!
!! delay
    delay(1) = delay(1) + trpdel + pcv(1)/VLIGHT + reldel + dphwp/FREQ1_J
    delay(2) = delay(2) + trpdel + pcv(2)/VLIGHT + reldel + dphwp/FREQ2_J
!
!! satellite clock correction, and save it for output clock estimates
    ...
    range1 = phase1 - dphwp/FREQ1_J*VLIGHT - pcv(1)
    range2 = phase2 - dphwp/FREQ2_J*VLIGHT - pcv(2)
!
